...
class MetricsAnalyzer:
    ...
    async def analyze_deployment(
        ...
        if not before or not after:
            return {
                "has_metrics": False,
                "error": "Missing metrics snapshots"
            }
        ...
        if before.error_rate is not None and after.error_rate is not None:
            ...
            if change["percent_change"] and change["percent_change"] > cls.THRESHOLDS["error_rate_increase"]:
                issues.append({
                    "metric": "error_rate",
                    "severity": "critical",
        ...
        if before.request_rate is not None and after.request_rate is not None:
            ...
            if change["percent_change"] and change["percent_change"] < -cls.THRESHOLDS["request_rate_drop"]:
                issues.append({
                    "metric": "request_rate",
                    "severity": "warning",
        ...
        if before.latency_p95 is not None and after.latency_p95 is not None:
            ...
            if change["percent_change"] and change["percent_change"] > cls.THRESHOLDS["latency_increase"]:
                issues.append({
                    "metric": "latency_p95",
                    "severity": "warning",
        ...
        if before.cpu_usage is not None and after.cpu_usage is not None:
            ...
            if change["percent_change"] and change["percent_change"] > cls.THRESHOLDS["cpu_increase"]:
                issues.append({
                    "metric": "cpu_usage",
                    "severity": "warning",
        ...
        if before.memory_usage is not None and after.memory_usage is not None:
            ...
            if change["percent_change"] and change["percent_change"] > cls.THRESHOLDS["memory_increase"]:
                issues.append({
                    "metric": "memory_usage",
                    "severity": "warning",
